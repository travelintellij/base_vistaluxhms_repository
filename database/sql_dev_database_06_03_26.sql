CREATE DATABASE  IF NOT EXISTS `ashokadb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ashokadb`;
...
INSERT INTO `hotel_central_config` VALUES (1,'','','','','','','','','','','','','','','','',0,'','','','','','','','','','','','2026-03-05 13:15:53','','','','','');
...
-- Dump completed on 2026-03-06 12:30:33
...
--
-- Updates for Social Lead Sync
--

ALTER TABLE `hotel_central_config` ADD COLUMN `meta_page_access_token` text AFTER `instagram_link`;
ALTER TABLE `hotel_central_config` ADD COLUMN `meta_lead_form_id` varchar(255) DEFAULT NULL AFTER `meta_page_access_token`;
ALTER TABLE `hotel_central_config` ADD COLUMN `meta_graph_api_version` varchar(50) DEFAULT NULL AFTER `meta_lead_form_id`;
ALTER TABLE `hotel_central_config` ADD COLUMN `default_lead_owner_id` int DEFAULT NULL AFTER `meta_graph_api_version`;

ALTER TABLE `lead_master` ADD COLUMN `meta_lead_id` varchar(100) DEFAULT NULL AFTER `updated_at`;
ALTER TABLE `lead_master` ADD COLUMN `meta_form_id` varchar(100) DEFAULT NULL AFTER `meta_lead_id`;
