...
INSERT INTO `ashokateam` VALUES (1,'admin','$2a$10$4Nu0P7O.eM/KMrqXzbbV5.DtzmVv.UWV9w1HoOT8PTXxhkT9UVpUK','Sushil Chugh','Vikas Puriu',9999449267,'Partner',NULL,NULL,0,NULL,'sushil@vistaluxhotel.com',NULL,NULL,'sushil@vistaluxhotel.com',9999441267,NULL,NULL,NULL,NULL,'perfect',1,0,0,0,0),(3,'RITIK','$2a$10$kllIHy8xTfjTiE5CKs2bVONJKtFzvWEPNn3RKTGzo/gIAUmHXsc5W','Ritik Makker','rz-28 subhash park ext-2 bindapur matiala rd uttam nagar new delhi-110059',9968228221,'USER',NULL,NULL,0,'2028-10-04','ritik.makker@gmail.com',NULL,'2026-03-02','ritik.makker@gmail.com',9968228221,NULL,NULL,NULL,NULL,'',1,0,0,0,0);
...
CREATE TABLE `event_images` (
  ...
  UNIQUE KEY `UKoa9v7v7unokfhp9fwmtqj09jl` (`event_id`,`image_index`),
...
CREATE TABLE `event_master_service` (
  ...
  KEY `FKncnvmlhmyhkl4i6lr20qe01po` (`eventServiceCostTypeId`),
  CONSTRAINT `fk_event_type` FOREIGN KEY (`eventTypeId`) REFERENCES `eventtype` (`eventTypeId`),
  CONSTRAINT `FKncnvmlhmyhkl4i6lr20qe01po` FOREIGN KEY (`eventServiceCostTypeId`) REFERENCES `event_service_cost_type` (`eventServiceCostTypeId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event_package_service` (
  ...
  KEY `FK1p8hr7dtd2d3ly55qm4u9hk13` (`service_type`),
  CONSTRAINT `event_package_service_ibfk_1` FOREIGN KEY (`package_id`) REFERENCES `event_package` (`id`),
  CONSTRAINT `FK1p8hr7dtd2d3ly55qm4u9hk13` FOREIGN KEY (`service_type`) REFERENCES `event_service_cost_type` (`eventServiceCostTypeId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hotel_central_config` (
  ...
  `meta_lead_form_id` varchar(255) DEFAULT NULL,
  `meta_graph_api_version` varchar(50) DEFAULT NULL,
  `default_lead_owner_id` int DEFAULT NULL,
  ...
  `whats_app_registration_template_id` varchar(50) DEFAULT NULL,
  `whats_app_stay_quotation_template_id` varchar(50) DEFAULT NULL,
  `whats_app_guest_quotation_template_id` varchar(50) DEFAULT NULL,
  `meta_app_id` varchar(255) DEFAULT NULL,
...
INSERT INTO `hotel_central_config` VALUES (1,'','','','','','','','','','','','','','','','',0,'','',NULL,NULL,NULL,NULL,'','','','','','','','','','2026-03-05 13:15:53','','','','','',NULL,NULL,NULL);
...
INSERT INTO `lead_master` VALUES (1,1,2,0,0,0,'','','2026-02-18','2026-02-20',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(2,1,2,0,0,0,'','','2026-02-12','2026-02-13',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(3,1,2,0,0,0,'','','2026-02-05','2026-02-06',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(4,1,2,0,0,0,'','','2026-02-13','2026-02-14',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(5,1,2,0,0,0,'','','2026-02-20','2026-02-27',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(6,1,2,0,0,0,'','','2026-02-06','2026-02-07',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(7,1,2,0,0,0,'','','2026-03-05','2026-03-06',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(8,1,2,0,0,0,'','','2026-02-07','2026-02-08',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(9,1,2,1,0,0,'','','2026-02-25','2026-02-26',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(10,2,2,1,0,0,'','','2026-02-26','2026-02-28',101,NULL,0,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL),(11,1,1,1,1,1,'','','2026-03-01','2026-03-02',101,NULL,1,0,1,0,0,0,1,1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `leads_team_map` (
  ...
  CONSTRAINT `FKpd6p9i989kggvevwmdi0suj5h` FOREIGN KEY (`userId`) REFERENCES `ashokateam` (`userId`),
...
INSERT INTO `master_room_details` VALUES (1,'deluxe room','','',2,5,1,0,0,1,1,35,20);
...
INSERT INTO `salespartner` VALUES (1,'Janvi Mehra','Janvi Mehra',2,9999441267,'janvimehra2004@gmail.com',10,'','','',1,'2026-02-05 08:22:37','2026-02-26 13:12:30'),(9,'DIGITAL MARKETING','Digital Marketing',NULL,0,NULL,501,NULL,'System Generated','Default partner for Social Media Leads',1,'2026-03-06 10:50:12',NULL);
...
--
-- Table structure for table `social_lead_log`
--

DROP TABLE IF EXISTS `social_lead_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `social_lead_log` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `social_lead_log`
--

LOCK TABLES `social_lead_log` WRITE;
/*!40000 ALTER TABLE `social_lead_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `social_lead_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-07 16:07:10
