...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; border: none; margin: 0; padding: 0;">
    <colgroup>
        <col style="width: 8mm;" />
        <col style="width: 194mm;" />
        <col style="width: 8mm;" />
    </colgroup>
    <thead>
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="remarks-box">
                            ...
                            <p style="margin: 0; font-size: 14.5px; font-weight: 600;">${remarks?replace("\n","<br/>")}</p>
                        </div>
                        </#if>
                    ...
                    <p style="font-size: 15.5px;font-weight: 600;color:#000000;margin-top:15px;">
