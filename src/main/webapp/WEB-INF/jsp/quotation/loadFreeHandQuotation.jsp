...
<div class="container">
    ...
    <form:form method="post" action="process_fh_lead_quotation" modelAttribute="LEAD_FH_QUOTATION_OBJ">
        ...
        <!-- User Type Selection -->
          ...
          <br>
<a href="view_fh_leads_quotes?leadId=${LEAD_FH_QUOTATION_OBJ.leadEntity.leadId}" style="float: right;"> <button type="button" style="background-color: #04AA6D;">View Quotes List</button></a>
            ...
            <table id="roomsTable">
                <thead>
                    <tr>
                        ...
                        <th style=" background-color: #4CAF50;color: white;padding: 10px;text-align: center;border: 1px solid #ddd;">No. of Rooms</th>
                        ...
                        <th style=" background-color: #4CAF50;color: white;padding: 10px;text-align: center;border: 1px solid #ddd;">Price</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Dynamic Rows Will Be Added Here -->
                    <c:forEach var="room" items="${LEAD_FH_QUOTATION_OBJ.roomDetailsDTO}" varStatus="status">
                    <tr>
                     ...
                     <tr>
                       ...
                       <td><font color="blue"><b> &#8377; ${LEAD_FH_QUOTATION_OBJ.grandTotal} </b></font></td>
                     </tr>
                     <tr>
                        ...
                        <th style=" background-color:#4CAF50;color: white;padding: 10px;text-align: center;border: 1px solid #ddd;" colspan="2">Final Price :</th>
                         <td style="font-family: Arial, sans-serif;">&#8377;  <span id="finalPrice" style="font-size: 20px; font-weight: bold; color: blue;"> ${LEAD_FH_QUOTATION_OBJ.grandTotal - LEAD_FH_QUOTATION_OBJ.discount }</span></td>
                     </tr>
            </table>
        </div>
...
<script>
    $(document).ready(function () {
        $("#discount").on("input", function () {
            var grandTotal = parseFloat(${LEAD_FH_QUOTATION_OBJ.grandTotal}); // Get the grand total
