...
<div class="follow-up">
        <div class="follow-up-wrapper bs  container" style="background-color:lightgrey">
            <div class="follow-up-heading" style="padding-top:5px">
                <h1 style="color:blue;">Free Hand Quotation</h1>
            </div>
            ...
            <div class="button-container-right">
                <form:form action="view_create_lead_fh_quotation" modelAttribute="LEAD_OBJ" method="POST" style="display: inline;">
                    <form:hidden path="leadId" />
                    <input type="submit" value="Create Free Hand Quotation" class="action-btn">
                </form:form>
