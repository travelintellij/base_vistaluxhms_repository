            ...
            background-color: rgba(0, 0, 0, 0.6); z-index: 9999;">
                ...
                border-radius: 8px; width: 80%; max-width: 800px; position: relative;">
                        ...
                        <div class="container">
                            ...
                            <form:form method="post" action="process_system_quotation"
                                modelAttribute="LEAD_SYSTEM_QUOTATION_OBJ">
                                <form:hidden path="lsqid" />
                                <form:hidden path="versionId" />
                                <input type="hidden" id="clientId" name="clientEntity.clientId"
                                    value="${LEAD_SYSTEM_QUOTATION_OBJ.clientEntity.clientId}" />
                                <input type="hidden" id="leadId" name="leadEntity.leadId"
                                    value="${LEAD_SYSTEM_QUOTATION_OBJ.leadEntity.leadId}" />
                                ...
                                <br>
                                <button type="submit" class="btn" name="Back" id="Back" value="Back"
                    ...
                    Displays when WhatsApp message fails (wrong template ID, missing auth key, etc.)
                    The 'WhatsAppError' attribute is set by LeadQuotationController. -->
                               ...
                               text-align: left; font-size: 14px; position: relative;">
                                    ...
                                    <table id="roomsTable">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="room" items="${LEAD_SYSTEM_QUOTATION_OBJ.roomDetailsDTO}"
                                                varStatus="status">
                                                <tr>
                                                    <td>${room.roomCategoryName}</td>
                                                    <td>${room.mealPlanName}</td>
                                                    <td>
                                                        <font size="2">${room.adults} Adult(s)</font> | <font
                                                            color="blue" size="4"><b> &#8377; ${room.adultPrice} </b>
                                                        </font>
                                                    </td>
                                                    <td>
                                                        <font size="2">${room.cwb} CWB </font>| <font color="blue"
                                                            size="4"><b> &#8377; ${room.childWithBedPrice}</b></font>
                                                    </td>
                                                    <td>
                                                        <font size="2">${room.cnb} CNB </font> | <font color="blue"
                                                            size="4"><b> &#8377; ${room.childNoBedPrice}</b></font>
                                                    </td>
                                                    <td>
                                                        <font size="2">${room.extraBed} Extra Bed</font> | <font
                                                            color="blue" size="4"><b> &#8377; ${room.extraBedPrice}</b>
                                                        </font>
                                                    </td>
                                                    <td>${room.formattedCheckInDate} </td>
                                                    <td>${room.formattedCheckOutDate}</td>
                                                    <td>
                                                        <font color="#503732" size="4"> <b>&#8377; ${room.totalPrice}
                                                            </b></font>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                                ...
                                                <td>
                                                    <font color="blue"><b> &#8377;
                                                            <span id="grandTotalDisplay">${LEAD_SYSTEM_QUOTATION_OBJ.grandTotal}</span> </b></font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">&nbsp;<span id="errorMessage"
                                                        style="font-size: 14px; font-weight: bold;"></span></td>
                                                <th style=" background-color: red;color: white;padding: 10px;text-align: center;border: 1px solid #ddd;"
                                                    colspan="2">Discount :</th>
                                                <td>&#8377;
                                                    <form:input path="discount" type="number" id="discount"
                                                        name="discount"
                                                        style="width:70px;padding: 0px 0px;height:25px;" />
                                                </td>
                                                <th style=" background-color:#4CAF50;color: white;padding: 10px;text-align: center;border: 1px solid #ddd;"
                                                    colspan="2">Final Price :</th>
                                                <td style="font-family: Arial, sans-serif;">&#8377; <span
                                                        id="finalPrice"
                                                        style="font-size: 20px; font-weight: bold; color: blue;">
                                                        ${LEAD_SYSTEM_QUOTATION_OBJ.grandTotal -
                                                        LEAD_SYSTEM_QUOTATION_OBJ.discount }</span></td>
                                            </tr>
                                    </table>
                                </div>

                                <form:textarea path="remarks" name="remarks"
                                ...
                                <div class="button-container">
                                    <button type="submit" class="btn" name="Email" id="Email" value="Email">Email
                                        Quotation</button> |
                                    <button type="submit" class="btn" style="background-color: green;" name="whatsapp"
                                        id="whatsapp" value="whatsapp">WhatsApp Quotation</button> |
                                    <button type="submit" class="btn" name="EmailAndWhatsApp" id="EmailAndWhatsApp"
                                        value="EmailAndWhatsApp">Email & WhatsApp Quotation</button> |
                                    <button type="submit" class="btn" style="background-color: green;"
                                        name="SaveQuotation" id="SaveQuotation" value="SaveQuotation">Save
                                        Quotation</button>
                                    <button type="submit" class="btn" name="Download" id="Download"
                                        value="Download">Download Quotation</button>
                                </div>
