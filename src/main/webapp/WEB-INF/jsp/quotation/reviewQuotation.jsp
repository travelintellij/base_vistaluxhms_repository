        ...
        <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
                            ...
                            <form:form method="post" action="process_quotation" modelAttribute="QUOTATION_OBJ">
                                ...
                                <div class="container">
                                    <div class="form-group">
                                        ...
                                        <form:input path="guestName" id="guestName" name="guestName" class="input-field"
                                            style="height:50px;" required="required" />
                                    </div>

                                    <div id="clientBox"
                                        style="width: 700px;height: 60px;padding: 8px 12px;font-size: 16px;border: 2px solid #4CAF50;border-radius: 8px;background: linear-gradient(white, #f1f1f1);color: #333;outline: none;cursor: pointer;transition: all 0.3s ease-in-out;">
                                        <c:if test="${QUOTATION_OBJ.contactMethod ne 'email'}">
                                            ...
                                            <form:input path="mobile" type="text" id="mobile" name="mobile"
                                                class="input-field" minlength="10" maxlength="10" pattern="\d{10}"
                                                oninput="this.value=this.value.replace(/[^0-9]/g,'');" />

                                        </c:if>
                                        <c:if test="${QUOTATION_OBJ.contactMethod ne 'mobile'}">
                                            <label for="Email">Email:</label>
                                            <form:input path="email" id="email" name="email" class="input-field"
                                                style="width:250px;" />
                                        </c:if>
                                        <font color="red">
                    ...
                    The 'WhatsAppError' attribute is set by QuotationController/LeadQuotationController. -->
                               ...
                               text-align: left; font-size: 14px; position: relative;">
                                    ...
                                    <table id="roomsTable">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="room" items="${QUOTATION_OBJ.roomDetails}"
                                                varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <font size="2">${room.childWithBed} CWB </font>| <font
                                                            color="blue" size="4"><b> &#8377;
                                                                ${room.childWithBedPrice}</b></font>
                                                    </td>
                                                    <td>
                                                        <font size="2">${room.childNoBed} CNB </font> | <font
                                                            color="blue" size="4"><b> &#8377;
                                                                ${room.childNoBedPrice}</b></font>
                                                    </td>
                                                    <td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: Arial, sans-serif;">&#8377; <span
                                                        ...
                                                        ${QUOTATION_OBJ.grandTotal - QUOTATION_OBJ.discount }</span>
                                                </td>
                                            </tr>
                                    </table>
                                </div>
                                ...
                                <div class="button-container">
                                    ...
                                    <c:if test="${QUOTATION_OBJ.contactMethod ne 'email'}">
                                        <button type="submit" class="btn" style="background-color: green;"
                                            name="whatsapp" id="whatsapp" value="whatsapp">WhatsApp Quotation</button> |
                                    </c:if>
