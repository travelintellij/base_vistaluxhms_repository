...
<div class="form-container-wrapper" style="background: transparent !important;">
    <div class="form-container">
        <h2>View Session</h2>
    <form:form method="post" action="view_edit_session_form" modelAttribute="SESSION_MASTER_OBJ">
        <form:hidden path="sessionId" />
        <div class="form-row">
            <label for="salesPartner-id">Session Id:</label>
            <div class="form-value">
                <font color="blue">${SESSION_MASTER_OBJ.sessionId}</font>
            </div>
        </div>

        <div class="form-row">
            <label for="salesPartner-short-name">Session Name:</label>
            <div class="form-value">
        ...
        <div class="form-row">
            ...
            <div class="form-value">
                <c:choose>
                    <c:when test="${SESSION_MASTER_OBJ.active eq true}">Active</c:when>
        ...
        <div class="button-container">
            <input type="submit" value="Edit Session Master">
            <a href="view_session_list">
                <input type="button" class="clear-filter-btn" value="Back to Session List" />
            </a>
        </div>
    </div>
    </form:form>
