                    ...
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                        ...
                        <div class="page-container" style="display: flex; height: 100vh; overflow: hidden;">
                            ...
                            <div id="filter-sidebar" class="filter-sidebar"
                                style="width: 0; transition: 0.3s; overflow-x: hidden; background: #f4f4f4; height: calc(100% - 140px); position: fixed; z-index: 1000; left: 0; top: 90px; box-shadow: 2px 0px 5px rgba(0, 0, 0, 0.3);">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <!-- Edit -->
                                                                    <form action="view_edit_lead_form" method="POST"
                                                                        style="margin: 0;">
                                ...
                                fetch('<%= request.getContextPath() %>/sync_instagram_leads?campaignFormId=' + formId)
                                    ...
                                    .then(function (data) {
                                        ...
                                        if (data.success && data.newLeadsImported > 0) {
                                            ...
                                            // Refresh the page after a brief delay so user sees the toast
