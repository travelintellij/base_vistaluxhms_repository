                ...
                <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                        ...
                        <div class="form-container">
                            <form:form method="post" action="view_edit_lead_form" modelAttribute="LEAD_OBJ"
                                autocomplete="off">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-cell full-width">
                                        ...
                                        <div class="checkbox-group">
                                            <form:checkbox path="fit" id="fit" disabled="true" class="small-checkbox" />
                                            <label for="fit">FIT</label>
                                            <form:checkbox path="groupEvent" id="groupEvent" disabled="true"
                                                class="small-checkbox" /><label for="groupEvent">Group</label>
                                            <form:checkbox path="marriage" id="marriage" disabled="true"
                                                class="small-checkbox" /><label for="marriage">Marriage</label>
                                            <form:checkbox path="others" id="others" disabled="true"
                                                class="small-checkbox" /><label for="others">Others</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-cell"> <label>Email:</label>
                                        <form:checkbox path="notifyEmail" id="notifyEmail" disabled="true" />
                                    </div>
                                    <div class="form-cell"><label>SMS:</label>
                                        <form:checkbox path="notifySMS" id="notifySMS" disabled="true" />
                                    </div>
                                    <div class="form-cell"><label>WhatsApp:</label>
