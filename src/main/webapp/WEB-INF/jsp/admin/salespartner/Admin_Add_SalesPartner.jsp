                    ...
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                        ...
                        <div class="form-container-wrapper" style="background: transparent !important;">
                            <div class="form-container">
                                ...
                                <form:form method="post" action="create_create_sales_partner"
                                    modelAttribute="SALES_PARTNER_OBJ">
                                    <!-- First Row -->
                                    <div class="form-row">
                                        <label for="salesPartner-id">Sales Partner Id:</label>
                                        <label for="auto-generated">
                                            <font color="blue">Auto Generated</font>
                                        </label>
                                    </div>
                                    <div class="form-row">
                                        <label for="salesPartner-short-name">Rate Type:</label>
                                        <form:select path="rateTypeId" required="required" style="width:20%">
                                            <form:options items="${ACTIVE_RATE_TYPES_LIST}" itemValue="rateTypeId"
                                                itemLabel="rateTypeName" />
                                        </form:select>
                                    </div>
                                    <div class="form-row">
                                        <label for="salesPartner-short-name">Short Name:</label>
                                        <form:input path="salesPartnerShortName" name="salesPartnerShortName"
                                            placeholder="Enter Short Name" required="required" />
                                        <font color="red">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <form:input path="mobile" id="mobile" type="tel"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <form:select path="active" required="required" style="width:100%">
                                            <option class="service-small" value="true" <c:if
                                                test="${SALES_PARTNER_OBJ.active eq true}">selected</c:if>>Active
                                            </option>
                                            <option class="service-small" value="false" <c:if
                                                test="${SALES_PARTNER_OBJ.active eq false}">selected</c:if>>In-Active
                                            </option>
                                        </form:select>
                                    </div>
                                    <div class="form-row">
                                        <label for="address">Address:</label>
                                        <form:textarea path="address" maxlength="255" placeholder="Enter Address"
                                            cols="68" rows="3" />
                                        <font color="red">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <form:textarea path="description" maxlength="255"
                                            placeholder="Enter Description" cols="68" rows="5" />
                                        <font color="red">
                                    ...
                                    <div class="button-container">
                                        ...
                                        <sec:authorize access="hasAnyRole('ADMIN','SALES_PARTNER_MANAGE')">
                                            <a href="view_sales_partner_list"><input type="button"
                                                    class="clear-filter-btn"
                                                    value="View Sales Partners List"></input></a>
                                        </sec:authorize>
                                    </div>
                                </form:form>
                            </div>
