                ...
                <%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                        ...
                        <style>
                            ...
                            body {
                                opacity: .98;
                                /* Adjust the opacity for the background image */
                            }
                        </style>
                        <h2 style="text-align: center; color: #1a1a2e; margin-bottom: 20px;">Edit User</h2>

                        <div class="form-container" style="width: 60%; min-width: 60%; max-width: 60%;">
                            <c:if test="${not empty Error}">
                                <div
                                    style="background-color: #ffebee; color: #c62828; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #ef9a9a; text-align: center; font-weight: 500;">
                                    ${Error}
                                </div>
                            </c:if>
                            <c:if test="${not empty Success}">
                                <div
                                    style="background-color: #e8f5e9; color: #2e7d32; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #a5d6a7; text-align: center; font-weight: 500;">
                                    ${Success}
                                </div>
                            </c:if>
                            ...
                            <form:form method="post" action="edit_edit_user" modelAttribute="USER_OBJ">
                                ...
                                <div class="form-table">
                                    ...
                                    <div class="form-cell">
                                        <label for="field2" style="font-weight:600">Password <small
                                                style="font-weight: 400; color: #666;">(Leave blank to keep
                                    ...
                                    <div class="form-cell">
                                        <div class="radio-group-container">
                                            ...
                                            <c:if
                                                test="${LOGGED_IN_ROLE eq 'SUPERADMIN' && LOGGED_IN_USER.userId eq USER_OBJ.userId}">
                                        ...
                                        <c:if
                                            test="${(LOGGED_IN_ROLE eq 'SUPERADMIN' && LOGGED_IN_USER.userId ne USER_OBJ.userId) || (LOGGED_IN_ROLE ne 'SUPERADMIN')}">
                                            <div class="radio-group">
                                                <label>
                            ...
                            <div class="form-cell">
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        document.getElementById('dobFieldEdit').setAttribute('max', today);
                                    });
                                </script>
                                <!-- ===== AI MODIFICATION END ===== -->
                            </div>
                        ...
                        <div class="form-table">
                            ...
                            <div class="form-cell">
                                <div class="radio-group-container">
                                    ...
                                    <div class="radio-group">
                                        <label>
                                            <form:radiobutton path="accountLocked" name="accountLocked" value="YES"
                                                required="required" />
                                            <span>Yes</span>
                                        </label>
                                        <label>
                                            <form:radiobutton path="accountLocked" name="accountLocked" value="NO"
                                                required="required" />
                                            <span>No</span>
                                        </label>
                                    </div>
                        ...
                        <div class="button-container">
                            ...
                            <a href="view_users_list"><input type="button" class="clear-filter-btn"
                                    value="View User List"></input></a>
                        </div>
                        </form:form>
                        </div>
