            ...
            <head>
                ...
                <style>
                    ...
                    .three-columns textarea {
                        flex: 1;
                        resize: vertical;
                        /* allow user to expand vertically */
                    }
            ...
            <body>
                ...
                <div class="form-container">
                    <form:form modelAttribute="CENTRAL_CONFIG_OBJ" method="post" enctype="multipart/form-data"
                        action="create_edit_central_config">
                        ...
                        <div class="form-container">
                            ...
                            <div class="responsive-columns">
                                ...
                                <fieldset>
                                    ...
                                    <form:textarea class="input-field" path="quotationTopCover"
                                        placeholder="Enter quotation top cover content here..." rows="12" />
                                </fieldset>

                                <!-- Inclusions -->
                                <fieldset>
                                    <legend>Inclusions</legend>
                                    <form:textarea class="input-field" path="inclusions"
                                        placeholder="Enter inclusions (use line breaks or bullet symbols)" rows="12" />
                                </fieldset>

                                <!-- Terms & Conditions -->
                                <fieldset>
                                    <legend>Terms & Conditions</legend>
                                    <form:textarea class="input-field" path="tnc"
                                        placeholder="Enter terms and conditions" rows="12" />
                                </fieldset>
                                <fieldset>
                                    <legend>USP</legend>
                                ...
                                <fieldset>
                                    ...
                                    <form:textarea class="input-field" path="hotelInfo" placeholder="Enter Hotel Info"
                                        rows="12" />
                                </fieldset>
