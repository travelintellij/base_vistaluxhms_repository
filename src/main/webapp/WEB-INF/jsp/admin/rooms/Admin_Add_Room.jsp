...
<style>
    body {
        background-image: url('<%= request.getContextPath() %>/resources/images/roomadd.jpg');
...
.radio-group input[type="radio"]:focus + span {
 ...
 <div class="container">
        ...
        <form:form action="create_create_room_category" modelAttribute="ROOM_OBJ" method="post">
