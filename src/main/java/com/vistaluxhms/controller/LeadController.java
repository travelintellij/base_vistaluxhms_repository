...
public class LeadController {
    ...
    private List<LeadEntityDTO> generateFilteredLeadsVo(Page<LeadEntity> pagedResult) {
        ...
        while (filteredLeadsIterator.hasNext()) {
            ...
            leadsVO.setFormattedCheckInDate(
                    leadEntity.getCheckInDate() != null ? formatter.format(leadEntity.getCheckInDate()) : "-");
            leadsVO.setFormattedCheckOutDate(
                    leadEntity.getCheckOutDate() != null ? formatter.format(leadEntity.getCheckOutDate()) : "-");
